                ...
                <div style={styles.quickContactGrid}>
                  {[
                    ...
                    { 
                      label: "Telegram", 
                      sub: "@kibeproxy", 
                      link: "https://t.me/kibeproxy", 
                      color: "#0088cc",
                      icon: <path d="M20.665 3.717l-17.73 6.837c-1.21.486-1.203 1.161-.222 1.462l4.552 1.42 10.532-6.645c.498-.303.953-.14.579.192l-8.533 7.703-.33 4.955c.488 0 .704-.223.977-.485l2.344-2.278 4.875 3.6c.898.496 1.543.241 1.767-.83l3.197-15.065c.327-1.31-.5-1.905-1.63-1.41z"/>
                    },
                    { 
                      label: "Call Me", 
                      sub: "Voice Call", 
                      link: "tel:+254799289214", 
                      color: C.gold,
                      icon: <path d="M6.62 10.79c1.44 2.82 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/>
                    },
                    { 
                      label: "SMS", 
                      sub: "Quick Text", 
                      link: "sms:+254799289214", 
                      color: C.blue,
                    ...
                    <a key={c.label} href={c.link} target="_blank" rel="noreferrer" style={styles.quickContactCard} className="quick-btn">
                      <svg style={{ ...styles.quickContactIcon, fill: c.color }} viewBox="0 0 24 24">
                        {c.icon}
                      </svg>
                      <div>
